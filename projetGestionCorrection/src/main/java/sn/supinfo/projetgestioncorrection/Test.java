 ...
 */
package sn.supinfo.projetgestioncorrection;

import java.util.List;
import java.util.Scanner;
import sn.supinfo.projetgestioncorrection_implements.imp.ImpEtudiant;
import sn.supinfo.projetgestioncorrection_implements.imp.ImpGroup;
import sn.supinfo.projetgestioncorrection_implements.imp.ImpProf;
...
public class Test {
    public static void Menu(){
     ...
     public static void main(String args[]){
         ImpGroup groupeImp=new ImpGroup();
         ImpEtudiant etudiantImp=new ImpEtudiant();
         ImpProf professeurImp=new ImpProf();
        int choix;
